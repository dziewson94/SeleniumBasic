...
class SelectableInteractionsTest extends TestBase {

    private static final Logger logger = LoggerFactory.getLogger(SelectableInteractionsTest.class.getSimpleName());
