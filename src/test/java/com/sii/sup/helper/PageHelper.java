...
public class PageHelper {
    private static Logger logger = LoggerFactory.getLogger(PageHelper.class.getSimpleName());
    ...
    public void getElementWithChildText(WebElement element) {
    ...
    public String getWebElementStoreKey(WebElement element) {
        return element.getText() + element.getAttribute(Attributes.ID.getValue());
    }
